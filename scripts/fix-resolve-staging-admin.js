/**
 * Fix admin user password in Resolve staging database
...
async function fixResolveAdmin() {
    const client = new Client({
        connectionString: process.env.DATABASE_URL,
        ssl: false // Resolve staging doesn't require SSL
    });

    try {
        console.log('🔌 Connecting to Resolve staging database...');
        await client.connect();
        console.log('✅ Connected to Resolve staging database');
        ...
        console.log('\n========================================');
        console.log('✅ Admin user is ready in Resolve staging!');
        console.log('📧 Email: admin@resolve.io');
        console.log('🔑 Password: admin123');
        console.log('🌐 Local URL: http://localhost:5000');
        console.log('🌐 Prod URL: https://onboarding.resolve.io/');
        console.log('========================================\n');
