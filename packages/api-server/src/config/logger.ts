...
const createTransports = () => {
	...
	try {
		...
		console.warn(
			"Could not create rotating file transport, using console only:",
...
export const queueLogger = createChildLogger("rabbitmq");
export const orgLogger = createChildLogger("organization");
export const messageLogger = createChildLogger("message");

// Correlation ID utilities
export const generateCorrelationId = (): string => randomUUID();

// Create context logger with correlation ID and user context
