...
describe('DataSourceStatusConsumer - Delegation Verification', () => {
  ...
  describe('successful delegation verification clears error fields', () => {
      ...
      mockQuery
        .mockResolvedValueOnce({
          rows: [{
            ...
            submitted_settings: { instanceUrl: 'https://test.service-now.com' },
          }],
        })
    ...
    it('should handle previously failed connection being re-verified', async () => {
      ...
      mockQuery
        .mockResolvedValueOnce({
          rows: [{
            ...
            submitted_settings: { url: 'https://company.atlassian.net', email: 'admin@company.com' },
          }],
        })
      ...
      expect(params[0]).toBe(JSON.stringify({ url: 'https://company.atlassian.net', email: 'admin@company.com' })); // settings
