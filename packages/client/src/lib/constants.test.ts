	...
	describe('validateFileForUpload', () => {
		...
		it('validates all supported extensions', () => {
			const supportedFiles = [
				...
				new File([''], 'doc.docx', { type: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' }),
		...
		it('rejects all unsupported extensions', () => {
			const unsupportedFiles = [
				...
				new File([''], 'file.xlsx', { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' }),
			]
