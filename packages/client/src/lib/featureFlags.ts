 ...
 *
 * LocalStorage-based feature flag system for RITA.
...
export const getFeatureFlag = (key: FeatureFlagKey) =>
	featureFlags.getFlag(key);
export const setFeatureFlag = (key: FeatureFlagKey, value: boolean) =>
	featureFlags.setFlag(key, value);
export const toggleFeatureFlag = (key: FeatureFlagKey) =>
	featureFlags.toggleFlag(key);
export const resetFeatureFlag = (key: FeatureFlagKey) =>
