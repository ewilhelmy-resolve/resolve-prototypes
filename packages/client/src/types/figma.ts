 ...
 * integration with RITA architecture.
 */
...
export interface FigmaConversionMetadata {
	...
	/** RITA specific customizations applied */
...
/**
 * RITA specific component configuration
 */
...
export interface FigmaWrapperProps extends FigmaComponentProps {
	/** Whether to apply RITA enterprise styles */
