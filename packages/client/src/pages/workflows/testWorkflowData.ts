	...
	workflow: [
		{
			...
			snippet: {
				...
				description:
					"Removes duplicate values from a list of numbers provided in context['numbers'] and stores the result in context['unique_numbers']. Maintains the original order of elements. Handles empty lists gracefully.",
		...
		},
		{
			...
			snippet: {
				...
				description:
					"Multiplies each number in a list provided in context['numbers'] by 3 and stores the result in context['multiplied_numbers']. Handles empty lists gracefully and validates input type.",
		...
		},
		{
			...
			snippet: {
				...
				description:
					"Sorts a list of numbers provided in context['numbers'] in ascending order and stores the result in context['sorted_numbers']. Handles empty lists gracefully and validates input type.",
