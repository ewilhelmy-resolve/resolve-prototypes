		...
		skills: [
			{
				...
				dryRunSummary:
					"Matches KB-284 'VPN DNS reset' with 91% confidence",
			...
			},
			{
				...
				dryRunSummary:
					"Would ping user 10 min after and check telemetry",
		...
		skills: [
			{
				...
				dryRunSummary:
					"Classifies as Network > VPN, urgency=High (SLA 4h)",
			...
			},
			{
				...
				dryRunSummary:
					"Routes to 'Network-L2' queue based on category + site",
...
export function getMockAgentById(id: string | null | undefined): MockAgent | null {
	if (!id) return null;
