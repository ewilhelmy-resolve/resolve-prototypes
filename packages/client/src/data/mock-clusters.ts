...
const MOCK_TICKETS: Ticket[] = [
	...
	},
	{
		...
		description:
			"New laptop cannot discover or connect to corporate WiFi network.",
		external_status: "Open",
		cluster_text: null,
		rita_status: "NEEDS_RESPONSE",
		source_metadata: {},
	...
	},
	{
		...
		description:
			"Print jobs stay in queue and never reach the printer on 3rd floor.",
		external_status: "Resolved",
		cluster_text: null,
		rita_status: "COMPLETED",
		source_metadata: {},
	...
	},
	{
		...
		description:
			"Time-based codes from authenticator are rejected. Clock sync attempted.",
		external_status: "Open",
		cluster_text: null,
		rita_status: "NEEDS_RESPONSE",
		source_metadata: {},
	...
	},
	{
		...
		description:
			"HTML signature renders as plain text when replying to external emails.",
		external_status: "Resolved",
		cluster_text: null,
		rita_status: "COMPLETED",
		source_metadata: {},
	...
	},
	{
		...
		description:
			"PC performance degraded significantly after last Tuesday's patch cycle.",
		external_status: "Open",
		cluster_text: null,
		rita_status: "NEEDS_RESPONSE",
		source_metadata: {},
	...
	},
	{
		...
		description:
			"Shared mailbox was provisioned but does not auto-map in Outlook client.",
		external_status: "Resolved",
		cluster_text: null,
		rita_status: "COMPLETED",
		source_metadata: {},
	...
	},
	{
		...
		description:
			"VPN certificate expired and self-service renewal portal returns error.",
		external_status: "Open",
		cluster_text: null,
		rita_status: "NEEDS_RESPONSE",
		source_metadata: {},
	...
	},
	{
		...
		description:
			"Requested password reset 2 hours ago, no email received. Checked spam.",
		external_status: "Resolved",
		cluster_text: null,
		rita_status: "COMPLETED",
		source_metadata: {},
	...
	},
	{
		...
		description:
			"All Teams calls disconnect after approximately 5 minutes. Browser and desktop app both affected.",
		external_status: "Open",
		cluster_text: null,
		rita_status: "NEEDS_RESPONSE",
		source_metadata: {},
