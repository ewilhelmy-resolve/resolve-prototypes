		...
		versions: [
			{
				version: 1,
				name: "Password Reset",
				description: "Basic password reset with AD lookup",
				endpointSlug: "password-reset",
				workflowId: "pw-1",
			...
			},
			{
				version: 2,
				name: "Password Reset",
				description: "Added audit logging",
				endpointSlug: "password-reset",
				workflowId: "pw-1",
				skillIds: ["skill-1", "skill-3", "skill-6"],
				status: "active",
		...
		versions: [
			{
				version: 1,
				name: "Device Provisioning",
				description: "Basic device inventory check",
				endpointSlug: "device-provisioning",
				workflowId: null,
				skillIds: ["skill-5"],
				status: "active",
			...
			},
			{
				version: 2,
				name: "Device Provisioning",
				description: "Added AD lookup and workflow",
				endpointSlug: "device-provisioning",
				workflowId: "pw-3",
