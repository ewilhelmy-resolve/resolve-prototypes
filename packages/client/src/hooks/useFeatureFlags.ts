...
export function useFeatureFlags() {
	...
	const getPlatformValue = useCallback(
		(key: FeatureFlagKey): boolean | undefined => {
	...
	const setPlatformFlag = useCallback(
		async (key: FeatureFlagKey, value: boolean): Promise<boolean> => {
