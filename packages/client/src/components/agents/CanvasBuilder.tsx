		...
		items: [
			{
				id: "lookup-tickets",
				name: "Lookup Tickets",
				description: "Search ticket history",
				icon: Search,
			},
			{
				id: "escalate-ticket",
	...
	const [jarvisMessages, setJarvisMessages] = useState<JarvisMessage[]>([
		{
			...
			role: "assistant",
			content:
				"Hi! I'm Jarvis, your AI assistant. I can help you build your agent workflow. What would you like to create?",
		},
	]);
			...
			<div className="flex-1 flex flex-col">
				...
				<div className="flex items-center justify-between px-4 py-2 border-b bg-white">
					...
					<div className="flex items-center gap-2">
						...
						<Button
							size="sm"
							onClick={() => onPublish({ name: agentName, description: "" })}
						>
							Publish
						</Button>
					</div>
				...
				{/* Canvas */}
				{/* biome-ignore lint/a11y/noStaticElementInteractions: drop zone for drag-and-drop canvas */}
