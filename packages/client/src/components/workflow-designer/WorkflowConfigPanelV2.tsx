...
const MOCK_VERSION_HISTORY = [
	{
		...
		author: "Shubham Wagdarkar",
		message: "Added Slack fallback channel",
		changes: 2,
		current: true,
	},
	{
		...
		author: "Ari Cohen",
		message: "Enabled verbose debug mode",
		changes: 1,
		current: false,
	},
	{
		...
		author: "Shubham Wagdarkar",
		message: "Added JSON parser strict mode",
		changes: 1,
		current: false,
	},
	{
		...
		message: "Initial Jira platform support",
		changes: 2,
		current: false,
	},
];
							...
							<div className="space-y-2.5">
								...
								>
									...
									{skillMetadata.inputsJson &&
										(() => {
											try {
												const inputs = JSON.parse(skillMetadata.inputsJson);
									...
									<div className="flex items-start gap-2 rounded-md border border-amber-300 bg-amber-50 p-2.5">
										...
										<div className="flex-1 min-w-0">
											<p className="text-xs text-amber-800 font-medium leading-snug">
												Workflow modified since last publish &mdash; 2 variables
												may need review
											</p>
											<Button
												variant="outline"
...
export function WorkflowConfigPanelV2({
	...
	const showFooter =
		topTab === "config" && hasNodeSelected && subTab === "settings";
