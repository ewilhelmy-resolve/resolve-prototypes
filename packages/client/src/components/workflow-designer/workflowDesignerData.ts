...
export const MOCK_WORKFLOW_VARIABLES: WorkflowVariable[] = [
	...
	{
		name: "firstName",
		activityId: "user-name-1",
		activityLabel: "User Name",
		type: "string",
	},
	{
		name: "lastName",
	...
	{
		name: "trimmedName",
		activityId: "trim-name-1",
		activityLabel: "Trim Name",
		type: "string",
	},
	// Azure AD User activity outputs
	{
		name: "azureUserId",
		activityId: "azure-user-1",
		activityLabel: "Azure AD User",
		type: "string",
	},
	{
		name: "azureUserPrincipalName",
		activityId: "azure-user-1",
		activityLabel: "Azure AD User",
		type: "string",
	},
	...
	// Filter activity outputs
	{
		...
		activityId: "filter-1",
		activityLabel: "Filter Results",
		type: "array",
	},
	{
		name: "filterMatchCount",
		activityId: "filter-1",
		activityLabel: "Filter Results",
		type: "number",
	},
	...
	{
		name: "displayName",
		activityId: "display-name-1",
		activityLabel: "Display Name",
		type: "string",
	},
	// Row Count activity outputs
	{
		name: "rowCount",
		activityId: "row-count-1",
		activityLabel: "Row Count",
		type: "number",
	},
	// If/Else activity outputs
	{
		name: "conditionResult",
		activityId: "if-else-1",
		activityLabel: "If / Else",
		type: "boolean",
	},
	{
		name: "branchTaken",
