import { CheckCircle2, Sparkles, ThumbsDown, ThumbsUp, X, XCircle } from "lucide-react";
			...
			<div className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-4">
				...
				<div className="flex flex-col gap-2">
					<div className="flex items-center justify-between">
						<span className="text-xs text-muted-foreground">Rate this evaluation</span>
						<Badge
							variant="secondary"
						...
						{evalCase.skillOutputs.map((output) => (
							...
							>
								<div className="flex items-center gap-2 mb-1">
									...
									<span className="text-xs font-medium">{output.skillName}</span>
								</div>
