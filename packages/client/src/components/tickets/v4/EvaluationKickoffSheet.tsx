...
const METHODS: {
	...
	},
	{
		value: "quality",
		label: "Exact match",
		description: "Strict text match against expected output. Coming soon.",
		available: false,
	},
];
				...
				<div className="px-4 pb-4 flex flex-col gap-5">
					...
					<div className="flex flex-col gap-2">
						...
						<p className="text-[11px] text-muted-foreground">
							Tickets are sampled from this cluster. ~30 sec per ticket —{" "}
							{sampleSize} tickets ≈ {Math.ceil((sampleSize * 30) / 60)} min.
						</p>
					</div>
