...
export function AgentDryRunSheet({
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: handleLogWithRating is stable within the sheet lifecycle
	useEffect(() => {
		if (!open || !agent || !ticket || readOnlyRun || !complete || logged)
			return;
		if (!autoRate) return;
