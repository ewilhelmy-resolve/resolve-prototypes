...
export default function TicketSettingsDialog({
	...
	}, [open, reset, settingsStore.blendedRatePerHour, settingsStore.timeToTake]);
				...
				>
					...
					<div className="flex flex-col gap-4">
						...
						<div className="grid gap-2">
							...
							<p id="timeToTake-help" className="text-sm text-muted-foreground">
				...
				<div className="rounded-md bg-muted/50 px-4 py-3 space-y-3">
					<div>
						...
						<p className="text-xs text-muted-foreground">
							${watch("blendedRatePerHour") || 0}/hr ×{" "}
							{watch("timeToTake") || 0} min × # of tickets ={" "}
							<span className="font-medium text-foreground">
								$
								{(
									(watch("blendedRatePerHour") || 0) *
									((watch("timeToTake") || 0) / 60)
					...
					<p className="text-xs text-muted-foreground">
						# of tickets is determined by your ticket data per cluster. These
						settings update the Est. Money Saved and Est. Time Saved metrics on
						the dashboard and cluster pages.
					</p>
				</div>
