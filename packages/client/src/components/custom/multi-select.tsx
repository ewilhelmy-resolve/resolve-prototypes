...
export const MultiSelect = React.forwardRef<MultiSelectRef, MultiSelectProps>(
	(
		...
		const effectivePlaceholder = placeholder ?? t("placeholders.selectOptions");
		...
		return (
			<>
				<div className="sr-only">
					{/* biome-ignore lint/a11y/useSemanticElements: screen reader live region */}
							...
							{selectedValues.length > 0 ? (
								<div className="flex justify-between items-center w-full">
											...
											.map((value) => {
												...
												return (
													...
													>
														...
														{/* biome-ignore lint/a11y/useSemanticElements: interactive badge remove */}
														<div
															role="button"
															tabIndex={0}
															onClick={(event) => {
									...
									<div className="flex items-center justify-between">
										{/* biome-ignore lint/a11y/useSemanticElements: clear all button */}
										<div
											role="button"
											tabIndex={0}
											onClick={(event) => {
											...
											aria-label={t("accessibility.clearAllSelected", {
						...
						<Command>
							{searchable && (
								<CommandInput
									...
									aria-label={t("accessibility.searchOptions")}
							...
							>
								<CommandEmpty>
									{emptyIndicator || t("states.noResults")}
								</CommandEmpty>{" "}
								{!hideSelectAll && !searchValue && (
									<CommandGroup>
										<CommandItem
											...
											aria-label={t("accessibility.selectAllOptions", {
										...
										>
											...
											<span>
												...
												{getAllOptions().length > 20
													? ` - ${t("multiSelect.optionsCount", { count: getAllOptions().length })}`
													: ""}
												)
											</span>
										</CommandItem>
